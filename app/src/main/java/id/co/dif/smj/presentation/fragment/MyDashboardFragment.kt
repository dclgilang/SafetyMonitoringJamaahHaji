...
import id.co.dif.smj.databinding.FragmentMyDashboardBinding
import id.co.dif.smj.databinding.ItemChartSelectedPopupBinding
import id.co.dif.smj.presentation.activity.ActiveUserActivity
import id.co.dif.smj.presentation.adapter.ActiveUsersAdapter
...
import id.co.dif.smj.utils.populateNakedBarChart
import id.co.dif.smj.utils.shimmerDrawable
import id.co.dif.smj.utils.toFormattedNumber
    ...
    override fun onViewBindingCreated(savedInstanceState: Bundle?) {
        ...
        viewModel.savedBasicInfo.observe(lifecycleOwner) {
            it?.let {
                ...
                binding.role = session?.emp_position
                it.cover?.let {
