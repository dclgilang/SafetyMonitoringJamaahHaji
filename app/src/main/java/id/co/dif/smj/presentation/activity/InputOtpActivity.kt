...
import id.co.dif.smj.databinding.ActivityInputOtpactivityBinding
import id.co.dif.smj.databinding.DialogPopupPasteBinding
import id.co.dif.smj.service.LocationClient
import id.co.dif.smj.utils.StatusCode
import id.co.dif.smj.utils.dimBehind
import id.co.dif.smj.utils.getClipboard
...
import id.co.dif.smj.utils.isNotNullOrEmpty
import id.co.dif.smj.utils.showSoftKeyboard
import id.co.dif.smj.viewmodel.InputOTPViewModel
    ...
    override fun onViewBindingCreated(savedInstanceState: Bundle?) {
        ...
        editTextList.forEach { editText ->
            editText.onFocusChangeListener = View.OnFocusChangeListener { _, hasFocus ->
                if (!hasFocus) {
                    val allEmpty = editTextList.all { it.text.isNullOrBlank() }
                    if (allEmpty) {
...
//        }
        ...
        binding.openAuthenticator.setOnClickListener {
