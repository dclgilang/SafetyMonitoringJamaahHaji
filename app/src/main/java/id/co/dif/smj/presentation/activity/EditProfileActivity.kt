...
import id.co.dif.smj.databinding.ActivityEditProfileBinding
import id.co.dif.smj.presentation.dialog.DialogUploadProfileCover
...
import id.co.dif.smj.utils.compressImage
...
import id.co.dif.smj.utils.getFileSizeInBytes
...
import id.co.dif.smj.utils.rotateImageCorrectly
...
class EditProfileActivity : BaseActivity<EditProfileViewModel, ActivityEditProfileBinding>() {
    ...
    override fun onViewBindingCreated(savedInstanceState: Bundle?) {
        ...
        info?.ktp?.let { ktp ->
            binding.fileKtp.loadImage(ktp, shimmerDrawable(), skipMemoryCaching = true)
        }
