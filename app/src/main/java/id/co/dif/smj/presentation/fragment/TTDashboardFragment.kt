...
import id.co.dif.smj.data.AreaBenchmark
import id.co.dif.smj.data.Employee
import id.co.dif.smj.data.PieChartLegend
import id.co.dif.smj.data.PlainValueLabel
import id.co.dif.smj.data.ProgressBarConclusion
import id.co.dif.smj.data.TicketTrend
import id.co.dif.smj.data.TroubleTicketTicketInfo
import id.co.dif.smj.data.TtTimeToClosed
import id.co.dif.smj.data.UserOverallRank
import id.co.dif.smj.databinding.FragmentTtDashboardBinding
import id.co.dif.smj.databinding.ItemChartSelectedPopupBinding
import id.co.dif.smj.presentation.adapter.PieChartLegendAdapter
import id.co.dif.smj.presentation.adapter.UserOverallRankAdapter
...
import id.co.dif.smj.utils.populateDottedDashedSmoothLineChartWithLabel
import id.co.dif.smj.utils.populateFadeUnderLine
import id.co.dif.smj.utils.populateFullPie
import id.co.dif.smj.utils.populateHorizontalRoundedGroupedChart
import id.co.dif.smj.utils.populateVerticalFadeTopGroupedChart
import id.co.dif.smj.viewmodel.TTDashboardViewModel
